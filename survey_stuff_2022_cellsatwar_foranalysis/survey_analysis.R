...
tiff("figures/time_spent_playing_videogames.tiff", units="in", width=8, height=6, res=300)
plot_survey_fun(time_spent_vg, time_spent_vg_labels, time_spent_vg_xtitle, time_spent_vg_ytitle, time_spent_vg_title)
dev.off()

#################################
### TRYING SOME BASIC PIE CHARTS#
#################################
pie(time_spent_vg$Freq, labels = time_spent_vg_labels, main = "Time Spent Playing Video Games", radius = 0.6)

# 3D Exploded Pie Chart
library(plotrix)
pie3D(time_spent_vg$Freq,labels = time_spent_vg_labels, explode=0.1,
      main="Time Spent Playing Video Games ")
#Q2
#############################################################################
...
tiff("figures/types_of_courses_taken.tiff", units="in", width=8, height=5, res=300)
...
###SAVING PLOT TO DIRECTORY
tiff("figures/how_often_haveyou_done_thefollowing.tiff", units="in", width=12, height=9, res=300)
...
memorizing_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
applying_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
analyzing_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
forming_labels <- c("NA","Quite a Bit", "Some", "Very Little", "Very Much")
...
tiff("figures/howmuch_coursework_emphasized_thefollowing.tiff", units="in", width=12, height=9, res=300)
...
combined_ideas2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
connected_learning2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
learned_something2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
connected_ideas2_labels <- c("NA","Quite a Bit", "Some", "Very Little", "Very Much")
...
###SAVING PLOT TO DIRECTORY
tiff("figures/how_does_gbl_help_in_science.tiff", units="in", width=12, height=9, res=300)
...
memorizing2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
applying2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
analyzing2_labels <- c("NA", "Quite a Bit", "Some", "Very Little", "Very Much")
...
forming2_labels <- c("NA","Quite a Bit", "Some", "Very Little", "Very Much")
...
tiff("figures/ifbio1a03_added_gblcomponent.tiff", units="in", width=12, height=9, res=300)
...
how_likely_labels <- c("NA", "Not Likely at All", "Not Very Likely", "Somewhat Likely", "Very Likely")
...
##SAVING THE PLOT TO DIRECTORY
tiff("figures/how_likely_you_would_play_cellsatwar.tiff", units="in", width=6, height=5, res=300)
...
how_prepared_labels <- c("NA", "Not Prepared at All", "Not Very Prepared", "Somewhat Prepared", "Very Prepared")
...
##SAVING THE PLOT TO DIRECTORY
tiff("figures/how_prepared_if_tested_on_pompe_based_off_cellsatwar.tiff", units="in", width=6, height=5, res=300)
