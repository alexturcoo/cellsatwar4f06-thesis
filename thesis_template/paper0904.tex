...
This project has developed an educational video game focused on a single gene disease, which presents students with important cellular and molecular biology concepts in an engaging and interactive manner. Through this study, we have found a way to supplement lecture material with a video game, and examined the impact of game-based learning on student motivation and engagement. This study also shows the immense benefits both students and faculty gain when engaging in a collaborative and interdisciplinary work-integrated learning experience.
